...
def main():
    ...
    lines = [
        ...
        "Use `scripts\\fetch-workflow-status.bat --stale-days 30` for the live GitHub Actions report.",
        "",
    ...
    lines.extend([
        ...
        "## Live report path",
        "",
        "- query latest workflow runs per repository with `scripts\\fetch-workflow-status.bat`",
