...
function Get-CommandOrNull {
	param([string]$Name)
	return [bool](Get-CommandPathOrNull $Name)
}
...
function Test-VulkanAvailable {
	...
	return (Get-CommandOrNull "vulkaninfo") -or (Get-CommandOrNull "glslc")
}

function Test-MetalAvailable {
	return $IsMacOS -and (Get-CommandOrNull "xcrun")
}
...
Write-Step "Done. ace-server is ready at $installedServer"
