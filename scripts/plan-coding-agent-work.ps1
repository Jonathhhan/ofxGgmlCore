...
if ($tasks.Count -eq 0 -and $managedReady.Count -gt 0) {
	...
	if ($core.Count -gt 0) {
		$tasks.Add((New-AgentTask `
			...
			-SuggestedFiles "docs/CODING_AGENT_WORK.md; docs/CONTROL_PLANE_NEXT_STEPS.md; docs/operational-validation-status.md; docs/of-smoke-build-strategy.md; docs/release-gating-strategy.md; scripts/status-family.ps1; scripts/test-family-status.ps1; scripts/audit-ecosystem.ps1; scripts/test-ecosystem-audit.ps1; scripts/plan-doctor-rollout.ps1; scripts/test-doctor-rollout-plan.ps1; scripts/check-ecosystem-readiness.ps1; scripts/plan-of-smoke-build.ps1; scripts/select-smoke-build-target.ps1; scripts/plan-smoke-build-target-handoff.ps1; scripts/check-smoke-build-target-preflight.ps1; scripts/check-smoke-build-target-postflight.ps1; scripts/plan-smoke-build-project-repair.ps1; scripts/plan-smoke-build-compile.ps1; scripts/build-smoke-example.ps1; scripts/run-smoke-build-ci.ps1; scripts/smoke-build-ci-report.ps1; scripts/plan-agent-branch-cleanup.ps1; scripts/test-agent-branch-cleanup.ps1; scripts/fetch-workflow-status.py; scripts/generate-release-readiness-score.py; scripts/plan-release-readiness.ps1" `
			-Validation "scripts/check-ecosystem-readiness.bat -SkipDoctorTests; scripts/check-ecosystem-readiness.bat -SkipDoctorTests -Json -SummaryOnly; scripts/status-family.bat -Json -SummaryOnly; scripts/test-family-status.ps1; scripts/audit-ecosystem.bat -Strict -Json -SummaryOnly; scripts/test-ecosystem-audit.ps1; scripts/plan-doctor-rollout.bat -Json -SummaryOnly; scripts/test-doctor-rollout-plan.ps1; scripts/plan-ecosystem.bat -Json -SummaryOnly; scripts/plan-release-readiness.bat -Json -SummaryOnly; scripts/test-workflow-status-report.ps1; scripts/test-release-readiness-score.ps1; scripts/test-release-readiness-plan.ps1; scripts/test-smoke-build-ci-report.ps1; scripts/test-agent-branch-cleanup.ps1; scripts/plan-agent-branch-cleanup.bat -Json -SummaryOnly; scripts/plan-smoke-build-target-handoff.bat -Stage generate-project -Json -SummaryOnly; scripts/check-smoke-build-target-preflight.bat -Stage generate-project -Json -SummaryOnly; scripts/check-smoke-build-target-postflight.bat -Stage generate-project -Json -SummaryOnly; scripts/plan-smoke-build-project-repair.bat -Stage verify-generated-project; scripts/plan-smoke-build-compile.bat -Stage compile-example; scripts/build-smoke-example.bat -Repository ofxGgmlSam -Example ofxGgmlSamPointExample"))
	}
