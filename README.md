...
The script downloads ggml (default ref: v0.11.0), builds static libraries, copies headers/libs into `libs/ggml`, and refreshes `addon_config.mk` library lists. Use `--clean` to wipe previous build/cache.
