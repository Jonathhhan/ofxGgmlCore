...
- GUI example SAM mode demonstrates the segmentation bridge with point-prompt controls and optional `sam.cpp` runtime attachment when the generated project includes sam.cpp headers and libraries
