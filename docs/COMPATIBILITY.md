...
| --- | --- | --- | --- | --- | --- |
| 1.0.5 | `ggml v0.11.0` (`ac6f7b4`) | Not bundled | Not bundled | Tested for ofxGgml CUDA build tier | `scripts/build-ggml.sh --cuda --clean` validates the addon-local ggml build. |
| 1.0.5 | `ggml v0.11.0` (`ac6f7b4`) | `record exact addon tag/commit` | `record exact commit/tag` | Pending | Fill this row when validating a combined ofxGgml + ofxStableDiffusion workspace. |
